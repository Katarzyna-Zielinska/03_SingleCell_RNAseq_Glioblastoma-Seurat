...
![Seurat](https://img.shields.io/badge/Seurat-single--cell-green)
![scRNA-seq](https://img.shields.io/badge/scRNA--seq-Single--Cell-orange)
![inferCNV](https://img.shields.io/badge/inferCNV-CNV-purple)
...
![PCA Elbow Plot](figures/PCA_ElbowPlot.png)

### PCA by Sample

![PCA by Sample](figures/PCA_PC1_PC2_by_sample.png)
...
![Canonical Cell-Type Markers](figures/CanonicalMarkers_DotPlot.png)
...
![Cell Composition by Percentage](figures/Cell_Composition_Percent.png)
